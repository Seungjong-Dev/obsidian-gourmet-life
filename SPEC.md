...
- A **Gourmet Explorer** view with card grid / list layout, multi-field filtering with counts, tag cloud, sort dropdown, ingredient search, summary stats bar, state persistence, and inline preview panel with related notes
